...
export const FriendRequestsSidebarOption: FunctionComponent<FriendRequestsSidebarOptionProps> = ({
    ...
    return (
        <Link
            ...
            <div className='flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-200 bg-white text-[0.625rem] font-medium text-gray-500 group-hover:border-indigo-600 group-hover:text-indigo-600'>
