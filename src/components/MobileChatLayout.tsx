...
import { ShortLogo } from '@/components/common/icons/Logo';
...
export const MobileChatLayout: FunctionComponent<MobileChatLayoutProps> = ({
    friends,
    session,
    sidebarOptions,
    unseenRequestCount,
        ...
        <div className='fixed inset-x-0 top-0 border-b border-zinc-200 bg-zinc-50 px-4 py-2'>
            <div className='flex w-full items-center justify-between'>
                <Link href='/dashboard' className={buttonVariants({ variant: 'ghost' })}>
                    <ShortLogo className='h-6 w-auto text-indigo-600' />
                </Link>
